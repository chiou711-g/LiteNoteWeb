...
<body>
		...
		<br><br>
		&emsp;<b>Page Id:</b>
		<input type="text" id="edit_page_id" name="editPageId" value="<%=pageId%>" size="10" readonly 
				style="color:white;background-color:#142b2b;border:solid 0px;">
		<ol>
		<li>
			<b>Page Title:</b>
			<input type = "text" id="edit_page_title" name = "editPageTitle" value ="<%=title%>" size="10" >
		</li>
 		<li>
		...
		<!-- show category info -->	
		使用 category Id:
		<input type = "text" id="edit_page_category_id" readonly name = "editPageCategoryId" value ="<%=category_id%>" size="10"
				style="color:white;background-color:#142b2b;border:solid 0px;">
		<br>		
		<!-- category list view  -->
		重選: &nbsp;
		<select id="category_selection" onchange ="getCategoryInfo()" onfocus="this.selectedIndex=-1"
		...
		<!-- Update button -->
		<input type = "button" value = "修改" id="varModifyPage" name="varModifyPage" 
			style="background-color:#490400;font-weight:bold;color:#ffffff;" >			
			
		&nbsp;&nbsp;&nbsp;&nbsp;
		
		<!-- Delete button -->
		<input type = "button" value = "刪除" id="varDeletePage" name="varDeletePage" 
