...
<body>
		...
		<br><br> &emsp;
		<b>Category Position:</b>
 		<input type = "text" id="edit_category_pos" name = "editCategoryPos" value ="<%=category_pos%>" size="10" readonly
 				 style="color:white;background-color:#142b2b;border:solid 0px;" >
		<ol>
 		<li>
			<b>Category Name:</b>
			<input type = "text" id="edit_category_name" name = "editCategoryName" value ="<%=category_name%>" size="10"
		...
		<!-- Update button -->
		<input type = "button" value = "修改" id="varModifyCategory" name="varModifyCategory" 
			style="background-color:#490400;font-weight:bold;color:#ffffff;width: 5em;" >			
			
		&nbsp;&nbsp;&nbsp;&nbsp;
		
		<!-- Delete button -->
		<input type = "button" value = "刪除" id="varDeleteCategory" name="varDeleteCategory" 
			style="background-color:#990400;font-weight:bold;color:#ffffff;width: 5em;" >		
		
		&nbsp;&nbsp;&nbsp;&nbsp;
		<!-- Delete all button -->
		<input type = "button" value = "刪除ALL" id="varDeleteAllCategory" name="varDeleteAllCategory" 
