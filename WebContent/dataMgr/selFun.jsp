...
<body>
	...
	<table border=0 width=100% align=right>
				...
				<form action="../../../LiteNoteWeb/dataMgr/addNew/addCategory.html">
					<div align="center">
						<input type="submit" value="Category"
							onclick="parent.postMessage('add new', '*');" />
					</div>
				</form>
			</td>
		</tr>
		...
		<tr>
			<td>
				<form action="../../../LiteNoteWeb/dataMgr/edit/editCategory.jsp">
					<input type="hidden" id="edit_category_id" name="editCategoryId"
						value="${categoryService.current_category_id}"> <input
						type="hidden" id="edit_category_name" name="editCategoryName">
					<div align="center">
						<input type="submit" value="Category"
							onclick="parent.postMessage('edit', '*');" />
					</div>
				</form>
			</td>
		</tr>
		...
		<tr>
			<td>
				<form action="../../../LiteNoteWeb/dataMgr/edit/editPage.jsp">
					<input type="hidden" name="editPageId"
						value="${pageService.pageTableId}"> <input type="hidden"
						id="edit_page_title" name="editPageTitle"> <input
						type="hidden" id="edit_page_category_id" name="editPageCategoryId">
					<div align="center">
						<input type="submit" value="Page"
							onclick="parent.postMessage('edit', '*');" />
					</div>
		...
		<tr>
			<td>
				<form
					action="../../../LiteNoteWeb/dataMgr/operation/swapCategory.jsp">
					<div align="center">
						<input type="submit" value="Category"
							onclick="parent.postMessage('swap', '*');" />
					</div>
				</form>
			</td>
		</tr>
		...
		<tr>
			<td>
				<form action="../../../LiteNoteWeb/dataMgr/operation/swapPage.jsp">
					<div align="center">
						<input type="submit" value="Page"
							onclick="parent.postMessage('swapPage', '*');" />
					</div>
				</form>
			</td>
		</tr>
		...
		<tr>
			<td>
				<form action="../../../LiteNoteWeb/dataMgr/operation/swapNote.jsp">
					<div align="center">
						<input type="submit" value="Link"
							onclick="parent.postMessage('swapLink', '*');" />
					</div>
				</form>
			</td>
		</tr>
		...
		<tr>
			<td>
				<form
					action="../../../LiteNoteWeb/dataMgr/operation/moveCategory.jsp">
					<div align="center">
						<input type="submit" value="Category"
							onclick="parent.postMessage('moveCategory', '*');" />
					</div>
				</form>
			</td>
		</tr>
		...
		<tr>
			<td>
				<form action="../../../LiteNoteWeb/dataMgr/operation/movePage.jsp">
					<div align="center">
						<input type="submit" value="Page"
							onclick="parent.postMessage('movePage', '*');" />
					</div>
				</form>
			</td>
		</tr>
		...
		<tr>
			<td>
				<form action="../../../LiteNoteWeb/dataMgr/operation/moveNote.jsp">
					<div align="center">
						<input type="submit" value="Link"
							onclick="parent.postMessage('moveLink', '*');" />
					</div>
				</form>
			</td>
		</tr>
