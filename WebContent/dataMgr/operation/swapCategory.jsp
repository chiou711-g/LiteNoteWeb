...
<body>
		...
		<ol>
		<li>
			<b>Category Position 1:</b>
	 		<input type = "text" id="swap_category_pos1" name = "swapCategoryPos1" size="10" style="background-color:Aquamarine;" >
		</li>
 		<li>
			<b>Category Position 2:</b>
			<input type = "text" id="swap_category_pos2" name = "swapCategoryPos2" size="10" style="background-color:Aquamarine;">
		</li> 
		</ol>
		&nbsp;&nbsp;&nbsp;&nbsp;
		
		<!-- Swap button -->
		<input type = "button" value = "互換" id="varSwapCategory" name="varSwapCategory" 
