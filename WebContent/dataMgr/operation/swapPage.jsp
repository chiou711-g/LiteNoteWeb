...
<body>
	...
	<fieldset>
		...
		<form id="swap_page_form" name="swapPageForm">
			...
			<ol>
				<li><b>Page Position 1:</b> <input type="text"
					id="swap_page_pos1" name="swapPagePos1" size="10"
					style="background-color: Aquamarine;"></li>
				<li><b>Page Position 2:</b> <input type="text"
					id="swap_page_pos2" name="swapPagePos2" size="10"
					style="background-color: Aquamarine;"></li>
			</ol>
			&nbsp;&nbsp;&nbsp;&nbsp;
