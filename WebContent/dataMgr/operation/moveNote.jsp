...
<body>
		...
		<ul>
 		<li>
			<b>From link Position 2:</b>
			<input type = "text" id="move_note_pos2" name = "moveNotePos2" size="10" style="background-color:Aquamarine;">
		</li> 		
		<li>
			<b>To link Position 1:</b>
	 		<input type = "text" id="move_note_pos1" name = "moveNotePos1" size="10" style="background-color:Aquamarine;" >
		</li>
		</ul>
		&nbsp;&nbsp;&nbsp;&nbsp;
		
		<!-- Move button -->
		<input type = "button" value = "搬動Link" id="varMoveNote" name="varMoveNote" 
