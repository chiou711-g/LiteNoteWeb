...
<body id="htmlbody">
	...
	<ol>
		...
		<ul>
			<li>
				<b>Link URI:</b>
				<input type="text" id="note_link_uri" placeholder="網址" name="noteLinkUri" size="48" value="">
			</li>
			<li>
		...
		<li>
			<b>Title:</b>
			<input  type = "text" id="note_title" name = "noteTitle"  size = "48" value ="" >
		</li>
		...
		<li>
			<b>指定 Image URI:</b>
			<textarea id="note_image_uri" name="noteImageUri"  rows="4" cols="60">
			</textarea>
		</li>	
