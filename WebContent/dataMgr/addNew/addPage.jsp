		...
		<form id="addPageForm" name="addPageForm">
			...
			<ol>
				<li><b>Page Title:</b> <input type="text" id="add_page_title"
					...
					style="background-color: #D6D6D6;"></li>

				<li><b>Category selection:</b> <!-- category list view  --> <select
					id="category_selection" onchange="getCategoryInfo();this.size=1; "
					...
					</c:forEach> <!-- show category info --> &emsp;&nbsp; <input type="text"
					id="add_page_category_info" name="addPageCategoryInfo" readonly
					size="25" value=""
					style="color: white; background-color: #142b2b; border: solid 0px;">
					<input type="hidden" id="add_page_category_id"
