...
<body>
	...
	<div align="center" style="border: 1px solid white">
		<!-- JSON file list -->
		<p>
			file: <input type="button" value="Select JSON"
				onclick="document.getElementById('file-input').click();"
				class="small_button" /> <input type="file" style="display: none;"
				id="file-input" name="file" />
			<!-- JSON file content -->
		<fieldset
			style="height: 100px; width: 98%; background-color: black; overflow: auto; font-size: 15px;">
			<legend>JSON file 內容:</legend>
			<pre id="json-file-content"></pre>
			<!-- <span id="json-file-content"></span> -->
		</fieldset>
		<p>
			<input type="button" id="import-json"
				onclick="importJsonContent(),showBar()" value="Run Import"
				class="small_button" />
		</p>
